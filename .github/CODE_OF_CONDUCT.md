<center><h1>Code de conduite</h1></center>

> Ce document accompagne le [readme](README.md), les [indications de contribution](CONTRIBUTING.md) ainsi que la [licence](LICENSE.md), merci d'en prendre connaissance.
...
- [Portée d'application](#portée-dapplication)
- [Application](#application)
- [Directives d'application](#directives-dapplication)
  - [1. Correction](#1-correction)
  - [2. Avertissement](#2-avertissement)
  - [3. Bannissement temporaire](#3-bannissement-temporaire)
  - [4. Bannissement permanent](#4-bannissement-permanent)
...
[@CESI-ORLEANS-A2](https://github.com/CESI-ORLEANS-A2).
