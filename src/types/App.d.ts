...
declare type ComponentsArgsMap = {
	"select": {
		...
		multiple?: boolean,
		options?: [
			{ text: string, value: string, selected?: boolean, disabled?: boolean }
		],
...
declare class App {
	...
	createComponent<K extends keyof ComponentsArgsMap>(name: K, args: ComponentsArgsMap[K]): Component;
	...
	watchVariable(variable: any, callback: (props: string | number, oldValue: any, newValue: any, obj: any) => void): void
	...
	dispatchEvent(element: HTMLElement | string | Array<HTMLElement | string>, eventName: string, detail?: any): void;
